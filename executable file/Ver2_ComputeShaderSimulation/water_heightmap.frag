...
void main()
{
    ...
    vec3 normal;
    normal.y = 1.0;
    normal.x = -(texture(texHeight, texcoord_vert+vec2(0.5/texRes, 0.0)).r - texture(texHeight, texcoord_vert-vec2(0.5/texRes, 0.0)).r);
    normal.z =  (texture(texHeight, texcoord_vert+vec2(0.0, 0.5/texRes)).r - texture(texHeight, texcoord_vert-vec2(0.0, 0.5/texRes)).r);
